...
export default function LlamaCppEmbeddingOptions({ settings }) {
  const {
  ...
  return (
    <div className="w-full flex flex-col gap-y-7">
      <div className="w-full flex items-start gap-[36px] mt-1.5">
        <LlamaCppEmbeddingModelSelection
          settings={settings}
      ...
      <div hidden={!showAdvancedControls}>
        <div className="w-full flex items-start gap-4">
          <div className="flex flex-col w-60">
            ...
            />
            <p className="text-xs leading-[18px] font-base text-white text-opacity-60 mt-2">
              Enter the URL where Llama.cpp is running.
            </p>
          </div>
        </div>
      </div>
...
function LlamaCppEmbeddingModelSelection({ settings, basePath = null }) {
  ...
  if (loading || customModels.length == 0) {
    return (
      <div className="flex flex-col w-60">
        ...
        <p className="text-xs leading-[18px] font-base text-white text-opacity-60 mt-2">
          Select the Llama.cpp model for embeddings. Models will load after
          entering a valid Llama.cpp URL.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col w-60">
      ...
      <p className="text-xs leading-[18px] font-base text-white text-opacity-60 mt-2">
        Choose the Llama.cpp model you want to use for generating embeddings.
      </p>
    </div>
  );
}
